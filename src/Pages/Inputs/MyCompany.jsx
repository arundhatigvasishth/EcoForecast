                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-2 text-[#324D3E]/70">
                            Springfield, Massachusetts • Mid-Sized Outpatient
                            Facility
                        </p>
                    </div>
                ...
                <div className="mt-10 grid gap-6 lg:grid-cols-2">
                    ...
                    <div className="rounded-2xl border border-black/10 bg-white/40 backdrop-blur-sm p-6 shadow-sm">
                        ...
                        <div className="mt-5 space-y-3 text-sm">
                            ...
                            <div className="pt-3 border-t border-black/10 text-[#324D3E]/70">
                                Riverbend Clinic serves the greater Hampden
                                County region, focusing on primary care, women’s
                                health, and preventative services. The clinic is
                                actively evaluating sustainable upgrades to
                    ...
                    <div className="rounded-2xl border border-black/10 bg-white/40 backdrop-blur-sm p-6 shadow-sm">
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-4">
                            ...
                            <Stat
                                label="Projected 5-Year Savings"
                                value="$184,200"
                            />
                        ...
                        <div className="mt-6 text-sm text-[#324D3E]/70">
                            Based on the most recent quarterly data submission
                            and projected operational scaling.
                        </div>
                    </div>
                </div>
