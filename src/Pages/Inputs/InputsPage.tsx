...
export default function InputsPage() {
    ...
    async function onSave() {
        ...
        try {
            ...
            // ✅ Navigate using the returned id
            navigate(`/outputs/${id}`);
        } catch (e: any) {
            ...
            <div className="mx-auto max-w-6xl px-6 py-10">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-[#324D3E]/80 max-w-2xl">
                        Enter resource usage and amount paid for each quarter.
                        We’ll calculate a spend preview before you continue.
                    </p>
                </div>
                    ...
                    <div className="lg:sticky lg:top-24 h-fit space-y-4">
                        <Card>
                            <div className="flex items-start justify-between gap-3">
                                <div>
                                    <div className="text-sm font-semibold text-[#324D3E]/80">
                                        Yearly Total Spend
                                    </div>
                            ...
                            <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                                <MiniStat
                                    label="Q1"
                                    value={moneyOrDash(previews.q1.total)}
                                />
                                <MiniStat
                                    label="Q2"
                                    value={moneyOrDash(previews.q2.total)}
                                />
                                <MiniStat
                                    label="Q3"
                                    value={moneyOrDash(previews.q3.total)}
                                />
                                <MiniStat
                                    label="Q4"
                                    value={moneyOrDash(previews.q4.total)}
                                />
                            </div>
                        </Card>
                        ...
                        <Card>
                            ...
                            <ul className="mt-2 text-sm text-[#324D3E]/75 space-y-2">
                                ...
                                <li>
                                    • Fill all fields before saving (validators
                                    will guide you).
                                </li>
                                <li>
                                    • Units are flexible (kWh, gallons/liters,
                                    miles) — be consistent per quarter.
                                </li>
                            </ul>
                        </Card>
                    </div>
        ...
        <Card>
            ...
            <div className="mt-3 space-y-3">
                <Row
                    ...
                    onPaid={(v) =>
                        props.onChange("electricity", "amountPaid", v)
                    }
                />
                <Row
                    label="Water"
...
function Row(props: {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr_1fr] gap-3 items-center">
            <div className="text-sm font-semibold text-[#324D3E]">
                {props.label}{" "}
                <span className="font-normal text-[#324D3E]/60">
                    ({props.hint})
                </span>
            </div>

            <div className="flex flex-col gap-1">
                <label className="md:hidden text-xs font-bold text-[#324D3E]/70">
                    Usage
                </label>
                <input
                    type="number"
